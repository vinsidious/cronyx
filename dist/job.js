...
class Job {
    ...
    get id() {
        if (!__classPrivateFieldGet(this, _Job_jobLock, "f") || !__classPrivateFieldGet(this, _Job_jobLock, "f").isActive)
            throw new error_1.CronyxError(`Job is not active for ${__classPrivateFieldGet(this, _Job_jobName, "f")}`);
    ...
    get intervalStartedAt() {
        if (!__classPrivateFieldGet(this, _Job_jobLock, "f") || !__classPrivateFieldGet(this, _Job_jobLock, "f").isActive)
            throw new error_1.CronyxError(`Job is not active for ${__classPrivateFieldGet(this, _Job_jobName, "f")}`);
        return (0, date_fns_1.subMilliseconds)(__classPrivateFieldGet(this, _Job_jobLock, "f").jobIntervalEndedAt, __classPrivateFieldGet(this, _Job_jobLock, "f").jobInterval);
    }
    get intervalEndedAt() {
        if (!__classPrivateFieldGet(this, _Job_jobLock, "f") || !__classPrivateFieldGet(this, _Job_jobLock, "f").isActive)
            throw new error_1.CronyxError(`Job is not active for ${__classPrivateFieldGet(this, _Job_jobName, "f")}`);
    ...
    async finish() {
        ...
        if (__classPrivateFieldGet(this, _Job_pendingPromise, "f"))
            throw new error_1.CronyxError(`Job is pending for ${__classPrivateFieldGet(this, _Job_jobName, "f")}`);
        ...
        __classPrivateFieldSet(this, _Job_pendingPromise, __classPrivateFieldGet(this, _Job_jobStore, "f")
            ...
            .then((jobLock) => {
            (0, util_1.log)(`Job is finished for ${__classPrivateFieldGet(this, _Job_jobName, "f")}`);
            __classPrivateFieldSet(this, _Job_jobLock, jobLock, "f");
            __classPrivateFieldSet(this, _Job_pendingPromise, null, "f");
        })
            .catch((error) => {
            __classPrivateFieldSet(this, _Job_pendingPromise, null, "f");
            throw new error_1.CronyxError(`Cannot finish job for ${__classPrivateFieldGet(this, _Job_jobName, "f")}`, { cause: error });
        }), "f");
    ...
    async interrupt() {
        ...
        __classPrivateFieldSet(this, _Job_pendingPromise, __classPrivateFieldGet(this, _Job_jobStore, "f")
            ...
            .then(() => {
            (0, util_1.log)(`Job is interrupted for ${__classPrivateFieldGet(this, _Job_jobName, "f")}`);
            __classPrivateFieldSet(this, _Job_jobLock, null, "f");
            __classPrivateFieldSet(this, _Job_pendingPromise, null, "f");
        })
            .catch((error) => {
            __classPrivateFieldSet(this, _Job_pendingPromise, null, "f");
            throw new error_1.CronyxError(`Cannot interrupt job for ${__classPrivateFieldGet(this, _Job_jobName, "f")}`, { cause: error });
        }), "f");
        return __classPrivateFieldGet(this, _Job_pendingPromise, "f");
    }
}
